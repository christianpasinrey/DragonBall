<script setup lang="ts">
  ...
  const PlanetsCarrousel = defineAsyncComponent(() => import('@/components/planets/PlanetsCarrousel.vue'));
</script>

<template>
  <main class="relative overflow-hidden flex flex-col h-full min-h-[90dvh] justify-center items-center content-center align-middle bg-transparent px-4 py-36 md:p-36">
