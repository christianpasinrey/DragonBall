...
<template>
  <main class="relative overflow-hidden flex flex-wrap h-full justify-center items-center content-center align-middle bg-transparent px-4 py-24 md:p-24">
    <div class="flex flex-col cursor-default items-center content-center align-middle gap-6 p-4 my-4 rounded-md text-clip justify-center text-center box border dark:bg-slate-800">
